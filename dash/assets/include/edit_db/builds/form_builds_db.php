...
<div class="row">
    ...
    <div class="col-sm">  
        <div class="row margin_bottom_25px">
            <div class="col-sm">
                <textarea name="1_peças" type="text" value="" class="form-control" style="height: 101px;" placeholder="Conjunto de 1 peça"><?php echo $conjuntos['1_peças']?></textarea>
            </div>
        </div>
        <div class="row margin_bottom_25px">
            <div class="col-sm">
                <textarea name="2_peças" type="text" value="" class="form-control" style="height: 101px;" placeholder="Conjunto de 2 peças"><?php echo $conjuntos['2_peças']?></textarea>
            </div>
        </div>
        <div class="row margin_bottom_25px">
            <div class="col-sm">
                <textarea name="4_peças" type="text" value="" class="form-control" style="height: 101px;" placeholder="Conjunto de 4 peças"><?php echo $conjuntos['4_peças']?></textarea>
            </div>
        </div>
    </div> 
    </div>
