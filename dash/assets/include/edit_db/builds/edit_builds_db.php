...
include '../../../../../assets/include/config.php';
    ...
    if($pdo->query($insert_p_db)) {
        ...
        document.querySelector("#edit_build .success").innerHTML= "Build <strong>'.$nome.'</strong> editada com sucesso!!";
        ...
        echo'<script>
        document.querySelector("#edit_build .error").innerHTML= "Erro ao editar a Build Selecionada!";
        setTimeout(function(){
